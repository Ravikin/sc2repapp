...
UNIT_COSTS = {
    # Example partial costs, extend this dictionary with real unit costs
    'Marine': (50, 0),
    'Zealot': (100, 0),
    'Zergling': (25, 0),
    'Stalker': (125, 50),
...
def parse_replay_to_txt(replay_file, output_txt):
...
if __name__ == "__main__":
    replay_path = "MaNa-DNS-LeyLines.SC2Replay"  # Replace with your replay file
    output_txt = "replay_events.txt"
    parse_replay_to_txt(replay_path, output_txt)
    print(f"Events logged to {output_txt}")